'''8.	A static method is the kind of method that is called in the context of a class, not objects that are created from that class. 
The following program defines a static method.'''
